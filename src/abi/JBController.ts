export const JBControllerABI = [
    ...
    outputs: [
      ...
      },
      {
        components: [
          {
            components: [
              { internalType: "bool", name: "allowSetTerminals", type: "bool" },
              {
                internalType: "bool",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_mustStartAtOrAfter", type: "uint256" },
      {
        components: [
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_projectId", type: "uint256" },
      { internalType: "contract IJBMigratable", name: "_to", type: "address" },
    ],
    name: "migrate",
    outputs: [],
    stateMutability: "nonpayable",
